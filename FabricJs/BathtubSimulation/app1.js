		...
		*/
		...
		/////////////////////DIFFERENT SHOWER HEAD CONTROLS ////////////
		var imgLow = document.getElementById('low_press');
		...
		var imgHigh = document.getElementById('high_press');
		...
		var pressureChooser = new fabric.Group([imgLowInt, imgHighInt], {originX: 'center', originY: 'center'});
